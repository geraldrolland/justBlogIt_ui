  ...
  return (
    <div className='w-[100%] scroll-smooth tab-container h-[100%] overflow-y-scroll'>
        <div className='md:w-[90%] relative w-[100%] flex flex-col mx-auto'>
            ...
            <img id='prevImage' className='w-[150px] block mx-auto  mt-4 h-[150px] object-cover rounded-full' src={isSuccess ? data.profile_image : placeholder} alt="" />
            ...
            <div className='w-[100%] md:h-[45px]  mx-auto mt-8 flex justify-between items-center h-[100px]  md:flex-row flex-col '>
                ...
                <input value={updateProfileDate.last_name} onChange={(e) => setEventToData(e)} className='md:w-[47%] md:h-[100%] w-[100%] dark:text-gray-400 h-[45px] dark:bg-gray-600  rounded-[3px] pl-2 focus:outline-none tracking-wide text-gray-700 bg-gray-300' type="text" placeholder='Last Name' />
            </div>
            <input value={updateProfileDate.username} onChange={(e) => setEventToData(e)} placeholder='Username' className='w-[100%] h-[45px]  mt-4 block tracking-wide mx-auto text-gray-700 dark:text-gray-400 dark:bg-gray-600 bg-gray-300 rounded-[3px] pl-2 focus:outline-none' type="text" />
            <input value={updateProfileDate.email} onChange={(e) => setEventToData(e)} placeholder='Email' className='w-[100%] h-[45px]  mt-4 block dark:text-gray-400 tracking-wide mx-auto text-gray-700 dark:bg-gray-600 bg-gray-300 rounded-[3px] pl-2 focus:outline-none' type="text" />
            <textarea value={updateProfileDate.bio} onChange={(e) => setEventToData(e)} placeholder='Bio' className='w-[100%] h-[250px]  mt-4 block tracking-wide pt-4 mx-auto text-gray-700 dark:text-gray-400 bg-gray-300 dark:bg-gray-600 rounded-[3px] pl-2 focus:outline-none resize-none' type="text"></textarea>
